        ...
        .then(csvText => {
            ...
            for (const [buildingFloor, classrooms] of Object.entries(groupedClassrooms)) {
                ...
                classrooms.forEach(classroomData => {
                    ...
                    classroomLink.href = `https://ichiken26.github.io/search_class/choicetime/table?faculty=${selectedFaculties}&building=${building}&floor=${floor}&classroom=${classroomName}`; // リンク先を設定
