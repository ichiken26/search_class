document.addEventListener("DOMContentLoaded", function() {
    ...
    nowtimeSearch.addEventListener("click", function(event) {
        ...
        if (clickednowtimeSearch){
            window.location.href = "https://ichiken26.github.io/search_class/nowtime/faculties.html";
        }
    });
    ...
    choicetimeSearch.addEventListener("click", function(event) {
        ...
        if (clickedchoicetimeSearch){
            window.location.href = "https://ichiken26.github.io/search_class/choicetime/choicetime.html";
        }
    });
    ...
    classroomsSearch.addEventListener("click", function(event) {
        ...
        if (clickedclassroomsSearch){
            window.location.href = "https://ichiken26.github.io/search_class/classrooms/classrooms.html";
        }
    });
});
